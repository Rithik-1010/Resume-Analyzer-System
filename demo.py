...
def main():
    ...
    print("[Demo] Resume Analysis Demo")
    print("=" * 40)
    ...
    try:
        ...
        if all_skills:
            ...
            print(f"[OK] Found {len(set(all_skills))} unique skills")
            ...
            print("[Warning] No skills found in sample")

        print("\n[OK] Demo completed successfully!")
        print("\n[Tip] To run full analysis:")
        print("   python src/resume_analyzer.py")
        print("\n[Tip] To launch dashboard:")
